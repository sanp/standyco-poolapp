    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pool_hall', models.CharField(max_length=200, verbose_name=b'Location')),
                ...
                ('game_other', models.CharField(max_length=200, null=True, verbose_name=b'Other Game', blank=True)),
                ('field_size', models.IntegerField(default=3, choices=[(0, b'2 man'), (1, b'4 players'), (4, b'16 players'), (3, b'32 players'), (4, b'64 players'), (5, b'Other')])),
                ('field_size_other', models.CharField(max_length=200, null=True, verbose_name=b'Other Field Size', blank=True)),
                ...
                ('fee', models.DecimalField(verbose_name=b'Entry Fee', max_digits=6, decimal_places=2)),
                ('added_money', models.DecimalField(max_digits=6, decimal_places=2)),
                ('added_money_based_on_full_field', models.BooleanField(default=True, choices=[(True, b'Yes'), (False, b'No')])),
                ('tourney_format', models.IntegerField(default=0, choices=[(0, b'Single elimination'), (1, b'Double elimination'), (2, b'Other')])),
                ('tourney_format_other', models.CharField(max_length=200, null=True, verbose_name=b'Other Format', blank=True)),
                ('race_to_single', models.IntegerField(null=True, verbose_name=b'Race to', blank=True)),
                ('race_to_a', models.IntegerField(null=True, verbose_name=b'Race to on A-Side', blank=True)),
                ('race_to_b', models.IntegerField(null=True, verbose_name=b'Race to on B-Side', blank=True)),
                ('has_calcutta', models.BooleanField(default=False, choices=[(True, b'Yes'), (False, b'No')])),
                ('green_fees_included', models.BooleanField(default=True, choices=[(True, b'Yes'), (False, b'No')])),
                ('green_fees', models.IntegerField(null=True, verbose_name=b'Green Fees', blank=True)),
                ...
                ('multiple_days', models.BooleanField(default=False, choices=[(True, b'Yes'), (False, b'No')])),
